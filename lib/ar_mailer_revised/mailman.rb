...
module ArMailerRevised
  class Mailman
    ...
    def deliver_emails
      ...
      logger.info("ArMailerRevised--> enter Mailman:deliver_emails: name:#{ArMailerRevised.email_class.name}")
      logger.info("ArMailerRevised--> enter Mailman:deliver_emails: methods:#{ArMailerRevised.email_class.methods}")
      begin
